...
public sealed partial class HoroscopePopoverView()
{
						 ...
						 new Grid()
							...
							.Children(
								...
								new StackPanel()
									...
									.Visibility(x => x
										.Binding(() => viewModel.ShowContent)
										.Convert(s => s ? Visibility.Visible : Visibility.Collapsed)
									),
